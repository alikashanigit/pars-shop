...
export const userAccountNameReducer = (state = {}, action) => {
    switch (action.type) {     
        case 'USER_ACCOUNT_NAME_REQUEST':
            return { ...state, loading: true };
        case 'USER_ACCOUNT_NAME_SUCCESS':
            return { ...state, loading: false, success: true, message: action.payload };
        case 'USER_ACCOUNT_NAME_FAIL':
            return { ...state, loading: false, success: false, error: action.payload };
        case 'USER_ACCOUNT_NAME_RESET':
            return {};
        default:
            return state;
    };
...
export const userAccountEmailEditReducer = (state = {}, action) => {
    switch (action.type) {     
...
export const userAccountEmailVerifyReducer = (state = {}, action) => {
    switch (action.type) {     
...
export const userAccountPasswordEditReducer = (state = {}, action) => {
    switch (action.type) {     
...
export const userAccountPasswordResetReducer = (state = {}, action) => {
    switch (action.type) {     
...
export const userAccountPasswordNewReducer = (state = {}, action) => {
    switch (action.type) {     
...
export const userAccountDeleteReducer = (state = {}, action) => {
    switch (action.type) {     
